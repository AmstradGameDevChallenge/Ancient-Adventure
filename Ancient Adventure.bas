...
1 ' this tool is useful when working the code in the real machine
...
1 ' ========== PRESENTATION ================================
200 MODE 1:BORDER 0:INK 0,0:INK 1,24:LOCATE 13,8:PRINT"ANCIENT ADVENTURE"
...
1 ' ENEMY 'eet' MOVES
3500 ex(eet)=ex(eet)+m(en(eet)):en(eet)=en(eet)+1:IF en(eet)=4 THEN en(eet)=0
3510 RETURN


1 ' ==================== PRESENTATION AND NEW GAME ======================
1 ' PRESS ENTER TO CONTINUE
10000 LOCATE 10,10:PRINT"PRESS ENTER TO CONTINUE"
10010 LOCATE 35,10:INPUT"",a$
10020 RETURN
